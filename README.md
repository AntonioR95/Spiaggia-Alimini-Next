<div align="center">
  ...
  **Sistema Gestionale Avanzato per l'Amministrazione e le Assegnazioni Balneari**
  ...
  [![Platform](https://img.shields.io/badge/platform-Windows-0078d7?style=for-the-badge&logo=windows)](https://github.com/AntonioR95/Spiaggia-Alimini-Next/releases)
</div>
...
**Spiaggia Alimini Next** è il software gestionale progettato per la gestione delle prenotazioni e delle assegnazioni dei posti spiaggia del comprensorio *Serra Degli Alimini 1*.
...
Per installare l'applicazione sul tuo computer Windows:
...
- **Electron 36+** — Motore desktop.
- **Next.js 16+ & React** — Framework per l'interfaccia utente.
- **TypeScript 5.9+** — Tipizzazione rigida e sicura per eliminare errori di runtime.
